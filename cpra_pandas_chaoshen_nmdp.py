...
#添加一个if函数，从而可以把字母个数为1，2，3，4，5的组分别选出来（S1-S5)。
#在进行公式运算，得出cpra。


	# nmdp_5l = pd.read_csv("/Users/muwuxu/Documents/Loran_Gragert/cpra_python/data/table.5l.nmdp.ag.csv")
	# print(nmdp_5l)
	# selected_data = nmdp_5l
	# for one_atigen in antigen:
	# 	selected_data = selected_data.loc[selected_data]


	# A1 = (nmdp_5l.loc[nmdp_5l[antigen] == 1, ethnics]).sum()
